...
#     # base.singleton_class.attr_writer :before_callbacks, :after_callbacks
#     # base.singleton_class.define_method :before_callbacks do
#     #   self.ancestors.each_with_object(@before_callbacks) do |ancestor, hash|
#     #     hash.merge!(
#     #       ancestor.instance_variable_get(:@before_callbacks) || {}
#     #     )
#     #   end
#     # end
#     # base.singleton_class.define_method :after_callbacks do
#     #   self.ancestors.each_with_object(@after_callbacks) do |ancestor, hash|
#     #     hash.merge!(
...
#       end
#
#       # singleton_class.attr_accessor :before_callbacks unless method_defined? :before_callbacks
...
#       end
#
#       # singleton_class.attr_accessor :after_callbacks unless method_defined? :after_callbacks
...
#       ancestors.reverse.detect { |ancestor| ancestor.is_a? Callbacks::Prepended }
#     end
#   end
#
...
#         Callbacks::Helpers.deep_merge_hashes_and_combine_arrays!(
#           hash,
#           ancestor.instance_variable_get(:@before_callbacks) || {}
#         )
#       end
...
#
#       all_before_callbacks = Callbacks::Helpers.deep_merge_hashes_and_combine_arrays(
...
#
#       all_after_callbacks = Callbacks::Helpers.deep_merge_hashes_and_combine_arrays(
...
#
#     def callbacks_prepended_module_instance
#       _callbacks_prepended_module_instance = self.singleton_class.ancestors.reverse.detect { |ancestor| ancestor.is_a? Callbacks::Prepended }
#
#       if _callbacks_prepended_module_instance.nil?
#         self.singleton_class.prepend Callbacks::Prepended
#         _callbacks_prepended_module_instance = self.singleton_class.ancestors.reverse.detect { |ancestor| ancestor.is_a? Callbacks::Prepended }
#       end
#
